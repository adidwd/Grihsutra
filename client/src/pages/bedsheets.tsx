...
export default function Bedsheets() {
  ...
  const { data: products = [], isLoading } = useQuery<Product[]>({
    queryKey: ["/api/products/category/bedsheets"],
  });
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Bedsheets Collection</h1>
            <p className="text-xl text-neutral">Premium comfort for the perfect night's sleep</p>
          </div>
        </div>
      </section>
